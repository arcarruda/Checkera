...
- bucket/AppStore/iphone-*.png, ipad-*.png + README.md
...
SVG_DIR = REPO_ROOT / "bucket" / "SVG"
ASSETS = MOBILE_APP / "Checkera" / "Resources" / "Assets.xcassets"
...
APPSTORE_DIR = REPO_ROOT / "bucket" / "AppStore"
...
def write_appstore_readme() -> None:
    ...
    out.write_text(
        ...
        "\n"
        "These PNGs are synthetic mockups generated by `mobile-app/Scripts/generate-ios-assets.sh`.\n"
